...
**Three-level framework** (per Tkemaladze J. (2026) "Patient as a Project", *Longevity Horizon* 2(5), ):
...
AIM имеет **tool-using executor** (Claude-style agency) с **33 tools** (sync'd с `agents/generalist.py` 2026-05-02; +ze_verify, +ze_verify_symbol):
...
| `lab_reference.py` | База лабораторных норм (71 аналит) |
